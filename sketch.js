...
function draw() {
  ...
  text('factor: ' + toFixed(factor, 1), 0 - textXOffset + offsetX / 6, height / 2 - minDim / 40 + offsetY / 6);
  textAlign(RIGHT);
  text('points: ' + toFixed(points, 3), textXOffset + offsetX / 6, height / 2 - minDim / 40 + offsetY / 6);
